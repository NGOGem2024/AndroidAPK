...
type ItemDetailsExpandedRouteProp = RouteProp<MainStackParamList, "ItemDetailsExpanded">;
...
const ItemDetailsExpanded: React.FC<ItemDetailsExpandedProps> = ({ route, navigation }) => {
    ...
    const filteredStockDetails = stockDetails.filter((stock) => {
        ...
        return (
            ...
            (stock.UNIT_NAME?.toString().toLowerCase().includes(searchLower) ?? false) ||
            (stock.BATCH_NO?.toString().toLowerCase().includes(searchLower) ?? false) ||
            (stock.AVAILABLE_QTY?.toString().toLowerCase().includes(searchLower) ?? false) ||
            (stock.BOX_QUANTITY?.toString().toLowerCase().includes(searchLower) ?? false) ||
            (stock.EXPIRY_DATE?.toString().toLowerCase().includes(searchLower) ?? false) ||
                    ...
                    <View style={styles.toggleContainer}>
                        ...
                        >
                            <Icon
                                ...
                                size={23}
                                color={!isTableView ? "#F48221" : "#F48221"}
                            />
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={[
                        ...
                        >
                            <Icon
                                ...
                                size={23}
                                color={isTableView ? "#007bff" : "#007bff"}
                            />
                        </TouchableOpacity>
                    </View>
                </View>
